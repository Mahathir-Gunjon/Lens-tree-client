                        ...
                        <div className="w-full lg:w-3/12 p-4 flex justify-center">
                            <div className="card w-72">
                                ...
                                <div className="card-body items-center text-center">
                                    ...
                                    <h2 className="text-2xl text-secondary">Countries</h2>
                                </div>
                            </div>
                        </div>
                        <div className="w-full lg:w-3/12 p-4 flex justify-center">
                            <div className="card w-72">
                                ...
                                <div className="card-body items-center text-center">
                                    <h2 className="text-5xl font-extrabold">932</h2>
                                    <h2 className="text-2xl text-secondary">Project Completed</h2>
                                </div>
                            </div>
                        </div>
                        <div className="w-full lg:w-3/12 p-4 flex justify-center">
                            <div className="card w-72">
                                ...
                                <div className="card-body items-center text-center">
                                    <h2 className="text-5xl font-extrabold">432</h2>
                                    <h2 className="text-2xl text-secondary">Happy Clients</h2>
                                </div>
                            </div>
                        </div>
                        <div className="w-full lg:w-3/12 p-4 flex justify-center">
                            <div className="card w-72">
                                ...
                                <div className="card-body items-center text-center">
                                    <h2 className="text-5xl font-extrabold">672</h2>
                                    <h2 className="text-2xl text-secondary">Feedbacks</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex justify-center mt-20">
                        <div className="stats glass rounded-sm text-primary-content shadow-2xl lg:p-10">
                            <div className="stat">
                            ...
                            <div className="stat flex items-center">
                                <div className="stat-actions">
                                    <button className="btn btn-lg btn-secondary mx-3 shadow-md">Withdrawal</button>
                                    <button className="btn btn-lg btn-accent mx-3 shadow-md">deposit</button>
                                </div>
                            </div>
                        </div>
                    </div>
